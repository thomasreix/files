...
def draw_world(screen, grid, view_start, visible_cols, visible_rows, cell_size, x_offset, alive_color, dead_color):
...
def draw_menu(screen, menu_width, menu_height, line_color, bg_color):
    ...
    for i in range(4):
        pygame.draw.line(screen, line_color,
                         ...
                         (menu_width - spacing, spacing + i * tile_size), 6)
        pygame.draw.line(screen, line_color,
                         (spacing + i * tile_size, spacing),
                         (spacing + i * tile_size, menu_width - spacing), 6)
...
def main():
    ...
    while True:
        ...
        screen.fill(black)
        draw_world(screen, grid, view_start, visible_cols, visible_rows, CELL_SIZE, menu_width + 5, white, black)
        draw_menu(screen, menu_width, screen_height, orange, black)
        pygame.draw.line(screen, orange, (menu_width + 5, 0), (menu_width + 5, screen_height), 6)
        pygame.display.flip()
